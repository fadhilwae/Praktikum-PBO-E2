public class Main {
    public static void main(String[] args) {
        ...
        d1.setIsi(new Anggora("Joy", 5.5));
        d2.setIsi(new Kembangtelon("Greg", 6.5));
        d3.setIsi(new Anjing("Wup", 10.9));
        ...
        kelompokAnabul.setIsi(1, new Anggora("Lawu", 6.9));
        kelompokAnabul.setIsi(2, new Kembangtelon("Jay", 4.5));
        kelompokAnabul.setIsi(3, new Anjing("Jack", 10.9));
        ...
        kelompokKucing.setIsi(1, new Anggora("Lawu", 6.9));
        kelompokKucing.setIsi(2, new Kembangtelon("Jay", 4.5));
